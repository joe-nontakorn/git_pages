...
function BackgroundBalls() {
  const bubbles = [
    {
      top: "20%", left: "10%", width: "180px", height: "180px",
      animation: "move1 15s ease-in-out infinite",
    },
    {
      top: "60%", left: "25%", width: "200px", height: "200px",
      animation: "move2 18s ease-in-out infinite",
    },
    {
      top: "40%", left: "70%", width: "150px", height: "150px",
      animation: "move3 22s ease-in-out infinite",
    },
    {
      top: "35%", left: "40%", width: "150px", height: "150px",
      animation: "move3 22s ease-in-out infinite",
    },    {
      top: "80%", left: "60%", width: "150px", height: "150px",
      animation: "move3 22s ease-in-out infinite",
    },
  ];
